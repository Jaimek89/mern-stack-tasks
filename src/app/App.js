                                    ...
                                    <form onSubmit={this.addTask}>
                                        <div className='row'>
                                            <div className='input-field col s12'>
                                                <input value={this.state.title} name='title' onChange={this.handlChange} type='text' placeholder='Task Title' />
                                            </div>
                                        </div>
                                        <div className='row'>
                                            <div className='input-field col s12'>
                                                <textarea value={this.state.description} name='description' onChange={this.handlChange} placeholder='Task Description' className='materialize-textarea'></textarea>
                                            </div>
                                        </div>
